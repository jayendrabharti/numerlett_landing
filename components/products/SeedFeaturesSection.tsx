...
export default function SeedFeaturesSection() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <Reveal className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A practical set of tools we&apos;re building for the work retailers
            actually do every day — from counting stock to closing the books.
          </p>
        </Reveal>
